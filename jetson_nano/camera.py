...
class Camera():
    ...
    def not_find_camera(self):
        frame = np.zeros((480, 640, 3), dtype=np.uint8)

        message = 'not find camera'
        ...
        cv2.putText(frame, message, text_position, font, font_scale, font_color, font_thickness)
    ...
    def update_drow(self, frame):
        ...
        cv2.putText(frame, messsege, (int(w/2),30), cv2.FONT_HERSHEY_COMPLEX,1,(255,255,255),2)
    # 업데이트된 사진들 다시 인코딩하기
